...
def handle_benchmark_dual(_ctx: CommandContext) -> bool:
    """Benchmarks the latency of the Dual LLM verification."""
    import time

    from llm_cli.security.dual_llm_verifier import verify_tool_call

    provider = config_manager.get("security", "dual_llm_provider") or "google"
    model = config_manager.get("security", "dual_llm_model") or "lite"
