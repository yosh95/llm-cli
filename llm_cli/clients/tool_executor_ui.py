...
def display_tool_request(ctx: Any, auto_approved: bool = False, delay: float = 0.0) -> None:
    ...
    if auto_approved:
        ...
        if delay > 0:
            title_text += f" [WAITING {delay:.1f}s]"
        panel_title.append(Text.from_markup(title_text, style="bold green"))
    else:
