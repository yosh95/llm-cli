...
\node [tierbox, fit=(identity) (mamba), label={[title]above:Tier 2: Behavioral Zero-Trust (Behavior)}] (t2box) {};
    ...
    % Final Execution
    \node [rectangle, draw, fill=blue!10, text width=7em, text centered, rounded corners, minimum height=3em, right=5.5cm of mamba, font=\small\bfseries] (exec) {Secure \\ Tool \\ Execution};
