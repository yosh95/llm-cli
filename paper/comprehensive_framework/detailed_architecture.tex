\begin{tikzpicture}[
    ...
    % Final Execution
    \node [rectangle, draw, fill=blue!10, text width=7em, text centered, rounded corners, minimum height=3em, right=1.6cm of entropy, font=\small\bfseries] (exec) {Secure \\ Tool \\ Execution};
