...
\begin{itemize}
    \item \textbf{ML-DSA-44 (Level 2):} Used for low-risk observations (e.g., \texttt{read_file}).
    \item \textbf{ML-DSA-65 (Level 3):} Default for standard tool operations.
    \item \textbf{ML-DSA-87 (Level 5):} Mandated for high-risk system modifications (e.g., \texttt{execute_python}).
\end{itemize}
