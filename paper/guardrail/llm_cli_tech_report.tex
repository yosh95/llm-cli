...
\begin{enumerate}
    ...
    \item Practical security guardrails for MCP-based tool execution, including restricted guest access and runtime validation that blocked all 32 attack vectors in our preliminary benchmark.
...
\begin{figure}[htbp]
    \centering
    \resizebox{\linewidth}{!}{\input{architecture.tex}}
...
\begin{figure}[htbp]
    \centering
    \resizebox{\linewidth}{!}{\input{sequence.tex}}
