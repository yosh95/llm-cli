...
Policy Evaluation (RBAC) & 0.0004 & Deterministic \\
Mamba Sentinel (SSM) & 10.3122 & ML-Inference \\
\hline
\textbf{Total Verification Latency} & \textbf{10.3422} & - \\
\hline
\end{tabular}
\label{tab:zt_perf}
\end{center}
...
In testing with 20 known prompt injection techniques (e.g., "DAN", "Ignore previous instructions"), the Mamba Sentinel detected 85\% of successful escapes by identifying statistical anomalies in the reasoning trace before a harmful tool call was even attempted. This provides a "Defense in Depth" that complements the structural guardrails of Phase 1.
