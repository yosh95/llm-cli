...
class TestBaseLlmClient:
    ...
    @pytest.fixture
    def concrete_client(self, mock_config: object) -> BaseLlmClient:  # noqa: ARG002
        ...
        class ConcreteClient(BaseLlmClient):
            ...
            def _send(
                ...
                return ("test response", None), {"tokens": 100}
    ...
    def test_initialization(self, concrete_client: BaseLlmClient) -> None:
    ...
    def test_set_model_success(self, concrete_client: BaseLlmClient) -> None:
    ...
    def test_set_model_failure(self, concrete_client: BaseLlmClient) -> None:
    ...
    def test_process_file_text(
        ...
        assert isinstance(temp_text_file, Path)
    ...
    def test_process_file_empty(
        ...
        assert isinstance(temp_empty_file, Path)
        result = process_file(temp_empty_file)
        assert result is None

    def test_process_sources_text_input(self, concrete_client: BaseLlmClient) -> None:
    ...
    def test_process_single_source_media(
        self, concrete_client: BaseLlmClient, temp_text_file: object
    ) -> None:
    ...
    def test_save_inline_image(
        ...
        log_entry, saved_path = concrete_client._save_inline_media_and_get_log_entry(
            inline_data
        )
    ...
    def test_talk_delegates_to_session(self, concrete_client: BaseLlmClient) -> None:
    ...
    def test_system_prompt_construction(self, monkeypatch: pytest.MonkeyPatch) -> None:
        """Test that system prompt includes date/time and base prompt."""

        def mock_get_setting(key: str, _section: str) -> str | None:
        ...
        assert "Current date:" in client.system_prompt
        assert "User name:" not in client.system_prompt

    def test_load_session_success(
        self, concrete_client: BaseLlmClient, tmp_path: object
    ) -> None:
        ...
        part = concrete_client.conversation[1].parts[0]
        assert isinstance(part, ContentPart)
        assert part.text == "Hi there"

    def test_load_session_file_not_found(self, concrete_client: BaseLlmClient) -> None:
    ...
    def test_load_session_invalid_json(
        self, concrete_client: BaseLlmClient, tmp_path: object
    ) -> None:
