...
class TestProviderClients:
    ...
    def test_initial_tool_activation(self, mock_config):  # noqa: ARG002
    ...
    def test_gemini_model_switching(self, mock_config):  # noqa: ARG002
...
class TestUnifiedClient:
    ...
    def test_unified_client_initialization(self, mock_config):  # noqa: ARG002
    ...
    def test_provider_switching(self, mock_config):  # noqa: ARG002
    ...
    def test_unified_model_aliases(self, mock_config):  # noqa: ARG002
    ...
    def test_invalid_provider(self, mock_config):  # noqa: ARG002
