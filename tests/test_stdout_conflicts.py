...
import sys
from llm_cli.apps.cli_common import run_client_cli, ClientConfig
from llm_cli.clients.base import BaseLlmClient

class RealMockClient(BaseLlmClient):
     def __init__(self, **kwargs):
        pass # Override init to do nothing
     def _load_model_aliases(self): pass
     def _send(self, data): return "", {}
     def process_sources(self, sources): pass
     def talk(self): pass
     def load_session(self, path): pass
