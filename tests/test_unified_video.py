...
def test_unified_client_handles_video_via_gemini(mock_config, mock_gemini_video_response, tmp_path):
    # Mocking Gemini's file upload and API response
    with patch('llm_cli.apps.gemini.GeminiClient._upload_file') as mock_upload, \
        ...
        with patch('filetype.guess') as mock_guess:
            ...
            assert file_part['file_data']['file_uri'] == "https://file-uri.com/video.mp4"
